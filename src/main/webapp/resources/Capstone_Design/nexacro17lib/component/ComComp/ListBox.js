...
if (!nexacro.ListBox) {
	...
	_pListBox._redrawListBoxContents = function (bScrollChange, post_call) {
		if (!post_call) {
			...
			win._postMessage(this, "_redrawListBoxContents", this._callbackPostmsg, [bScrollChange, true]);
			return;
		}
	...
	_pListBox._callbackPostmsg = function (e) {
		var args = e.data;
		switch (e.id) {
			case "_redrawListBoxContents":
				this._redrawListBoxContents(args[0], args[1]);
				break;
			case "setInnerDataset":
				this.setInnerDataset(args[0]);
				break;
			case "set_index":
				this.set_index(args[0]);
				break;
			case "_refreshScroll":
				this._refreshScroll(args[0], args[1]);
				break;
			default:
				break;
		}
