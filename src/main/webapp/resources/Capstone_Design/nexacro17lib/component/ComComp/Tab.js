...
if (!nexacro.Tab) {
	...
	_pTab.set_selectedtabbuttonwidth = function (v) {
		this.selectedtabbuttonwidth = parseInt(v) | 0;

		this._rearrangeContents();
	};

	_pTab.set_selectedtabbuttonheight = function (v) {
		this.selectedtabbuttonheight = parseInt(v) | 0;
	...
	_pTab._rearrangeContents = function (beginTabindex) {
		...
		if (!extrabutton_size) {
			...
			extrabutton_width = extrabutton_size.width | 0;
			extrabutton_height = extrabutton_size.height | 0;
		}
