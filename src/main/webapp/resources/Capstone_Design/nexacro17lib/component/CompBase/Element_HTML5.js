...
if (nexacro._Browser != "Runtime" && !nexacro.Element) {
	...
	_pControlElement._isMultiInnerProc = function () {
		var parent_elem = this.parent_elem;
		if (parent_elem && parent_elem._use_container_move && parent_elem._is_use_multiinner) {
	...
	nexacro.ScrollableControlElement = function (parent_elem, is_use_multiinner) {
		this.parent = parent_elem;
		this.parent_elem = parent_elem;
		this._is_use_multiinner = is_use_multiinner;

		var client_elem;
		if (is_use_multiinner) {
			client_elem = new nexacro._MultiInnerContainerElement(this);
		}
		else {
			client_elem = new nexacro._ContainerElement(this);
		}
	...
	_pScrollableControlElement._setInnerElementScrollMaxTops = function (tops) {
		if (!this._is_use_multiinner) {
			return;
		}

		this._client_elem._scroll_max_arr = tops;
	};
	...
	_pScrollableControlElement._on_change_clientSize = function (width, height) {
		...
		if (this._client_elem && this._client_elem._use_translate_scroll) {
			if (this._is_use_multiinner) {
				this._client_elem.setElementScrollMaxSize(max_width, max_height);
			}
			else {
	...
	__pMultiInnerContainerElement.create = function (win) {
		nexacro._ContainerElement.prototype.create.call(this, win);
		this._setScrollHeight(this._scroll_maxheight);
	};
	...
	__pMultiInnerContainerElement._setInnerElementScrollMaxTops = function (tops) {
	...
	__pMultiInnerContainerElement._removeExtinners = function () {
		var handle = this.handle;
	...
	__pMultiInnerContainerElement._setInnerElementExtend = function () {
		var handle = this.handle;
		var dest_handle = this.dest_handle;
		var _scroll_max = this._scroll_max_arr;
	...
	__pMultiInnerContainerElement._setScrollHeight = function (height) {
	...
	__pMultiInnerContainerElement.setElementScrollMaxSize = function (width, height) {
		nexacro._ContainerElement.prototype.setElementScrollMaxSize.call(this, width, height);
		this._setScrollHeight(height);
	};
