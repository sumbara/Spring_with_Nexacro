			...
			if (pre_idx != stepindex) {
				...
				if (form) {
					...
					if (form_control_elem) {
						...
						var form_container_elem = form_control_elem.getContainerElement(stepindex);
						var linkedcontrol = form_container_elem._findScrollbarControl(form_container_elem, true);
						if (linkedcontrol) {
							if (linkedcontrol._vscroll_pos != form_container_elem._scroll_top) {
								linkedcontrol._scrollTo(null, form_container_elem._scroll_top);
							}
						}
					}
